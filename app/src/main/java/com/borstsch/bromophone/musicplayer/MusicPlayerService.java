...
public class MusicPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public static final String ACTION_PREVIOUS = "com.borstsch.bromophone.musicplayer.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.borstsch.bromophone.musicplayer.ACTION_NEXT";
    public static final String ACTION_STOP = "com.borstsch.bromophone.musicplayer.ACTION_STOP";
    ...
    private void registerResumeAudio() {
        IntentFilter filter = new IntentFilter(PlayerActivity.Broadcast_RESUME);
        registerReceiver(resumeAudio, filter);
    }

    private void registerPauseAudio() {
        IntentFilter filter = new IntentFilter(PlayerActivity.Broadcast_PAUSE);
